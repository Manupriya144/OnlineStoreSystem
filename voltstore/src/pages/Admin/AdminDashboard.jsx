...
function AdminDashboard() {
  ...
  if (authLoading) return <div className="admin-page">Checking access...</div>;
  ...
  return (
    <section className="admin-page">
      <div className="admin-header">
        ...
        <p>Manage orders, repair requests, and products.</p>
      </div>

      <div className="admin-stats">
        <div><span>Total Orders</span><strong>{orders.length}</strong></div>
        <div><span>Pending Orders</span><strong>{orders.filter(o => o.order_status === "pending").length}</strong></div>
        <div><span>Repair Requests</span><strong>{repairs.length}</strong></div>
